...
#SBATCH --export=DATA="/ems/elsc-labs/adam-y/rotem.ovadia/Programs/invivo-imaging/Data/two_cells/cell1",FN="cell1.bin",CUTOFF_POINT=0.9,CORR_TH_FIX=0.4,PATCH_SIZE=300,BG_RANK=4
